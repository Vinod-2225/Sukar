...
class ProductsByCategoryAdapter(mActivity: Activity?, mList: ArrayList<ProductsData>) : RecyclerView.Adapter<ProductsByCategoryAdapter.ViewHolder>() {
    private val mDataset: ArrayList<String>? = null
    var mContext: Context? = mActivity
    var mList: ArrayList<ProductsData> = mList
    private val arraylist: ArrayList<ProductsData> = ArrayList()
