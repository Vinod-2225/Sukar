...
import com.designmaster.sukar.adapters.ShippingAddressListAdapter
import com.designmaster.sukar.models.AddressInfo
import com.designmaster.sukar.models.AddressListResponse
import com.designmaster.sukar.util.*
import java.util.ArrayList

class ShippingAddressFragment: BaseFragment(), ApiCallListener, View.OnClickListener {
    ...
    var addressListAdapter: ShippingAddressListAdapter? = null
    ...
    private fun idMappings() {
        ...
        addressListAdapter = ShippingAddressListAdapter(activity, addressInfo)
        addressesRecyclerView!!.adapter = addressListAdapter

        addressListAdapter!!.setOnClickListener(object : ShippingAddressListAdapter.ClickListener {
...
//                    (activity as MainActivity?)!!.supportFragmentManager.beginTransaction().replace(R.id.fragment_container, fragment1).addToBackStack(null).commit()
            ...
            override fun OnSelected(position: Int,address1: String) {

                addressId = addressInfo[position].id
                address = address1
        ...
        when (v.id) {
            ...
            R.id.btnApply -> {
                ...
                if(addressId != "" && address != ""){
                    ...
                    val intent = Intent(context, CartFragmentNew::class.java)
