 ...
 * Use the [OrderscontinuesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OrderscontinuesFragment : BaseFragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(
            R.layout.fragment_orderscontinues,
            container, false
    ...
    companion object {
         ...
         * @return A new instance of fragment OrderscontinuesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OrderscontinuesFragment().apply {
