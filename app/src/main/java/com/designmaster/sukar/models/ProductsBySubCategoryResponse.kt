...
data class ProductsBySubCategoryResponse (

    @SerializedName("output")
    val output: ProductsBySubCategory

)

data class ProductsBySubCategory (
    @SerializedName("success")
    val success: Int,
    @SerializedName("info")
    val info: List<ProductsBySubCategoryData>
)

data class ProductsBySubCategoryData (
    @SerializedName("id")
    val id: String,
